 ...
 * @author Jeff Hoye
 */
public class FileTransferApp implements Application {
  /**
  ...
  public FileTransferApp(Node node) {
    // register the endpoint
    this.endpoint = node.buildEndpoint(this, "FILETRANSFER");
    this.node = node;
    ...
    endpoint.accept(new AppSocketReceiver() {
      ...
      public void receiveSocket(AppSocket socket) {
        ...
        },FileTransferApp.this.node.getEnvironment());
  ...
  class MyFileListener implements FileTransferListener {
    public void fileTransferred(FileReceipt receipt,
      ...
      System.out.println(FileTransferApp.this+s+percent+"% of "+receipt);
    }
    ...
    public void transferCancelled(Receipt receipt, boolean incoming) {
      ...
      System.out.println(FileTransferApp.this+": Cancelled "+s+" of "+receipt);
    }
    ...
    public void transferFailed(Receipt receipt, boolean incoming) {
      ...
      System.out.println(FileTransferApp.this+": Transfer Failed "+s+" of "+receipt);
    }
  }
   ...
   */
  public void SendFileDirect(NodeHandle nh,final String filePath) {
